      ...
      <div className='upld_img'>
        ...
        <Dragger {...props} accept="image/*">
          ...
          <ul className='image_upload_instr'>
            ...
            <li>Please be sure not to violate others' copyright or privacy rights.</li>
          </ul>
        </Dragger>
        {imageError && <span className='error-message'>Please select an image.</span>}
      </div>
      <div className='upld_img'>
        ...
        {videoError && <span className='error-message'>Please select a video.</span>}
      </div>
