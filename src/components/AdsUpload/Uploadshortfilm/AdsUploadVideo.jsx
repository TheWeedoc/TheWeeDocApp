...
import Uploadvideo from "../../../Assests/Images/Uploadvideo.png";
import { AddUploadBtn } from "../../../Assests/Svg/Commonsvg";
function AdsUploadVideo({ current, onNext, onPrev, formData, setFormData }) {
      ...
      <div className="upld_img">
        ...
        >
          <div className="flex flex-col justify-center items-center py-4">
            <img src={Uploadvideo} alt="upload" className="w-20" />
            <div className=" flex flex-col justify-center items-center text-left py-4">
              <p className="ant-upload-text">
